...
All that to say, this code should be considered a **starting point** in future project development. Modernizing the code used in this project will likely decrease the computational burden substantially. 
